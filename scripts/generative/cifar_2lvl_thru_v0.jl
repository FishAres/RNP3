...
Dec_z_x̂ = Chain(
    ...
    BatchNorm(32, relu),
    ConvTranspose((6, 6), 32 => 32, stride=(2, 2)),
    BatchNorm(32, relu),
...
## ======
modelpath = "saved_models/gen_2lvl_thru/double_H_cifar_generative_thru_v0/add_offset=true_asz=6_bsz=64_esz=32_glimpse_len=4_img_channels=3_imszprod=1024_scale_offset=1.5_scale_offset_sense=3.2_seqlen=4_α=1.0_β=0.5_η=4e-5_λ=0.001_λf=1.0_λpatch=0.0_π=128_200eps.bson"

Hx, Ha, Encoder, Dec_z_x̂, Dec_z_a = load(modelpath)[:model] |> gpu
...
alias = "double_H_cifar_generative_thru_v0_cont"
