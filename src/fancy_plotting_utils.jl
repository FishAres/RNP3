...
function full_sequence_patches(models::Tuple, z0, a0, x; args=args, scale_offset=args[:scale_offset])
    patches, xys = [], []
...
function get_loop_patches(x; args=args)
    ...
    out1_patches, out_small, xys_1 = full_sequence_patches(z1, patch_t) |> gpu
