...
modelpath = "saved_models/gen_3lvl/double_H_mnist_2to4_rand_locs_generative_v0/add_offset=true_asz=6_bsz=64_esz=32_glimpse_len=4_img_channels=1_imzprod=784_scale_offset=2.0_scale_offset_sense=3.2_seqlen=4_α=2.0_β=0.01_η=4e-5_λ=0.001_λf=1.0_λpatch=0.0_π=32_200eps.bson"
