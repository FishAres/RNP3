...
modelpath = "saved_models/gen_2lvl/2lvl_double_H_eth80_50x50_segmented_vae_v01/add_offset=true_asz=6_bsz=64_depth_Hx=6_esz=32_glimpse_len=4_img_channels=3_imszprod=2500_scale_offset=1.8_scale_offset_sense=3.2_seqlen=4_α=1.0_β=0.2_δL=0.25_η=4e-5_λ=0.001_λf=0.167_λpatch=0.0_π=256_500eps.bson"
